...
class CompanyController extends Controller
{
    ...
    public function store(Request $request)
    {
        try{
            ...
            $mysqlTable = "CREATE TABLE ".$db_name.".users (id INT(6) UNSIGNED AUTO_INCREMENT PRIMARY KEY,username VARCHAR(30) NOT NULL,role VARCHAR(30) ,status VARCHAR(50),reg_date TIMESTAMP)";
